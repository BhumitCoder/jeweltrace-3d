...
const appCss = "/assets/styles-9bI3r7Ca.css";
...
const $$splitComponentImporter$8 = () => import("./verify-Blmw0_s8.js");
const Route$8 = createFileRoute("/verify")({
  head: () => ({
    meta: [{
      title: "Verify Report — JewelReport"
    }, {
      name: "description",
      content: "Enter your JewelReport number to verify the authenticity of your diamond, gemstone or jewellery certificate."
    }]
  }),
  validateSearch: (s) => ({
...
const $$splitComponentImporter$7 = () => import("./contact-78qkY0P4.js");
const Route$7 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get in touch with JewelReport Certification Lab for submissions, partnerships and inquiries."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./blog-CpkQ3luu.js");
const Route$6 = createFileRoute("/blog")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Insights on diamonds, gemstones, lab-grown stones and the world of fine jewellery."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./admin-C0zDFyIP.js");
const Route$5 = createFileRoute("/admin")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./about-BX_tyr7_.js");
const Route$4 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Independent gemological lab serving the global jewellery trade with precision grading, master gemologists and tamper-proof PVC certificates."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./index-Dwfh82Qd.js");
const Route$3 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Globally trusted gem & jewellery certification. Lab-grown diamonds, natural diamonds, gemstones and jewellery reports on a secure PVC card."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./blog._slug-BPbKPQ52.js");
const Route$2 = createFileRoute("/blog/$slug")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./admin.cert._id-BZpGoPPe.js");
const Route$1 = createFileRoute("/admin/cert/$id")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./admin.blog._id-DutsAhJm.js");
const Route2 = createFileRoute("/admin/blog/$id")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const VerifyRoute = Route$8.update({
  id: "/verify",
  path: "/verify",
...
const AdminCertIdRoute = Route$1.update({
  id: "/cert/$id",
  path: "/cert/$id",
  getParentRoute: () => AdminRoute
});
const AdminBlogIdRoute = Route2.update({
  id: "/blog/$id",
  path: "/blog/$id",
  getParentRoute: () => AdminRoute
});
