      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div style={{ fontSize: w * 0.017, letterSpacing: "0.22em", color: "#111111", fontWeight: 900 }} className="uppercase mt-0.5">
              Certification Lab
            </div>
          </div>
        </div>
    ...
    <div className="relative h-full w-full flex flex-col" style={{ padding: pad }}>
      ...
      <div className="flex items-center gap-2" style={{ marginBottom: 8 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: w * 0.016, letterSpacing: "0.22em", color: "#111111", fontWeight: 900 }} className="uppercase">
            Certification Lab
          </div>
        </div>
      </div>
