        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: compact ? 1.5 : 3, position: "relative", zIndex: 1 }}>
          {fields.map(([label, value]) => (
            <div key={label} style={{ display: "flex", alignItems: "flex-end", gap: 0 }}>
              <span style={{
                fontSize: 14.5, color: "#444444", whiteSpace: "nowrap",
              ...
              <span style={{
                fontSize: 14.5, fontWeight: 800, color: "#000000",
          ...
          {isJewellery && (cert.diamondShape || cert.diamondWeight || cert.diamondColor || cert.diamondClarity) && (
            <div style={{ marginTop: 4 }}>
              ...
              {[
                ...
                <div key={label} style={{ display: "flex", alignItems: "flex-end", gap: 0 }}>
                  <span style={{ fontSize: 14.5, color: "#444444", whiteSpace: "nowrap", lineHeight: 1.5, fontWeight: 500 }}>{label}</span>
                  <span style={{ flex: 1, borderBottom: "1.5px dotted #BBBBBB", margin: "0 6px 3px", minWidth: 20 }} />
                  <span style={{ fontSize: 14.5, fontWeight: 800, color: "#000000", whiteSpace: "nowrap", lineHeight: 1.5, letterSpacing: "0.03em", textTransform: "uppercase" }}>{value}</span>
                </div>
              ))}
            </div>
          )}
          ...
          {cert.remarks && (
            <div style={{ marginTop: 4 }}>
              <span style={{ fontSize: 14.5, color: "#444444", fontWeight: 500 }}>Remarks: </span>
              <span style={{ fontSize: 14.5, fontWeight: 700, color: "#111111" }}>{cert.remarks}</span>
            </div>
          )}
        </div>
