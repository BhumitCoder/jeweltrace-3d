...
export function SiteFooter() {
  return (
    <footer className="relative mt-32 border-t border-border bg-[var(--navy-deep)] text-white">
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 grid gap-12 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[10px] tracking-[0.3em] text-white/50 uppercase">Certification Lab</div>
            </div>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link to="/about" className="text-white/60 hover:text-primary">About</Link></li>
            <li><Link to="/verify" className="text-white/60 hover:text-primary">Verify Report</Link></li>
            <li><Link to="/blog" className="text-white/60 hover:text-primary">Blog</Link></li>
            <li><Link to="/contact" className="text-white/60 hover:text-primary">Contact</Link></li>
            <li><Link to="/admin" className="text-white/30 hover:text-primary text-xs">Admin</Link></li>
          </ul>
        </div>
      </div>
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-6 py-5 text-xs text-white/40 flex flex-wrap items-center justify-between gap-2">
