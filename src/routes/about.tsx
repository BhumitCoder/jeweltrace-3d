...
function AboutPage() {
  useSEO({
    ...
    path: "/about",
    keywords:
      "about JewelsReport, JewelsReport laboratory India, JewelsReport history, JewelsReport founded 2014, JewelsReport team, JewelsReport gemologists, JewelsReport instruments, JewelsReport methodology, JewelsReport standards, JewelsReport accreditation, gemological laboratory Surat, gem lab Surat India, independent gemological lab, third party diamond grading, master gemologist India, senior gemologist Surat, certified gemologist India, trained gemologist India, expert diamond grader, professional gem tester, 25 master gemologists, cross verified grading, independent second opinion diamond, grading panel India, diamond grading protocol India, ISO 17025 diamond lab, ISO IEC 17025 gemological, ISO aligned gem lab, accredited gem laboratory India, international standard diamond grading, global grading practice India, GIA equivalent India, IGI equivalent India, HRD equivalent India, AGS equivalent India, best alternative diamond lab India, neutral diamond grading, unbiased diamond certification, independent diamond appraisal, FTIR spectroscopy India, Fourier transform infrared spectroscopy, FTIR diamond testing, FTIR gemstone analysis, Raman spectroscopy India, Raman gem testing, Raman spectroscopy diamond, confocal Raman analysis, UV-Vis-NIR spectroscopy, ultraviolet visible near infrared, UV-Vis analysis gemstone, NIR spectroscopy diamond, photoluminescence spectroscopy India, PL spectroscopy diamond, photoluminescence gemstone, low temperature PL testing, DiamondView fluorescence imaging, DiamondView instrument India, blue fluorescence DiamondView, orange fluorescence DiamondView, phosphorescence testing diamond, phosphorescence gemstone, fluorescence microscope gemstone, binocular gemological microscope, darkfield illumination, brightfield microscope gem, fiber optic illuminator, gemological loupe 10x, inclusion mapping diamond, diamond plotting diagram, internal characteristic mapping, external characteristic recording, spectrophotometer gem lab, colorimeter gemstone, spectral analysis gem, EDXRF testing India, energy dispersive X-ray fluorescence, trace element gemstone, chemical composition analysis, specific gravity testing, refractive index measurement, refractometer gem, polariscope testing, dichroscope analysis, Chelsea filter gem, immersion microscopy, laser drill hole detection, flux healing detection, glass filling detection, fracture filling detection, lead glass filling ruby, cobalt glass blue sapphire treatment, beryllium diffusion detection, lattice diffusion sapphire, surface diffusion corundum, flux grown synthetic, hydrothermal synthetic, Verneuil synthetic, flame fusion synthetic, CVD synthetic diamond detection, HPHT synthetic diamond detection, natural diamond verification, natural vs synthetic gemstone, origin determination gemstone, geographic origin testing, Burma origin detection, Colombia origin detection, Kashmir origin detection, Ceylon origin detection, natural colour treatment free gemstone, enhanced gemstone detection, composite stone detection, doublet triplet detection, assembled stone identification, founded 2014 Surat India, established gem lab India, 10 years diamond lab, 12 years gem lab, 150000 certificates issued India, 30 countries diamond, India diamond capital, Surat diamond market, Surat diamond hub, Mahidharpura Surat lab, Surat Diamond Market address, Gujarat gem industry, western India diamond lab, India gem export, diamond export India, reputed certification India, trusted diamond lab India, best gem lab Surat, top gemological lab India, award winning gem lab, recognised gem lab India, referral diamond lab India",
    jsonLd: [
      breadcrumb([
        { name: "Home", path: "/" },
      ...
      ...team.map((m) => ({
        "@context": "https://schema.org",
        "@type": "Person",
        "@id": `${SITE_URL}/about#${m.name.toLowerCase().replace(/\s+/g, "-").replace(/[^a-z0-9-]/g, "")}`,
        name: m.name,
        jobTitle: m.role,
        url: `${SITE_URL}/about`,
        worksFor: { "@id": `${SITE_URL}/#organization` },
        description: `${m.role} at JewelsReport Gemological Laboratory with ${m.years} of experience in gemological sciences.`,
        knowsAbout: [
          "Gemological certification",
          "Diamond grading",
          "4Cs diamond analysis",
      ...
      })),
      {
        ...
        "@id": `${SITE_URL}/about#credential`,
        name: "ISO/IEC 17025 Aligned Protocols",
        description: "JewelsReport operates gemological testing protocols aligned with ISO/IEC 17025 international standard for testing and calibration laboratories.",
