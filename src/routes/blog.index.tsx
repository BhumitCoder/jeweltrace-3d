    ...
    jsonLd: [
      ...
      ]),
      {
        ...
        blogPost: posts.map((p) => ({
          ...
          image: p.coverDataUrl?.startsWith("http") ? p.coverDataUrl : `${SITE_URL}/og-image.jpg`,
          publisher: {
            "@type": "Organization",
      ...
      },
      {
        "@context": "https://schema.org",
        "@type": "ItemList",
        "@id": `${SITE_URL}/blog#articlelist`,
        name: "JewelsReport Journal — All Articles",
        description: "Complete list of gemological articles published by JewelsReport laboratory",
        url: `${SITE_URL}/blog`,
        numberOfItems: posts.length || 10,
        itemListElement: posts.length
          ? posts.map((p, i) => ({
              "@type": "ListItem",
              position: i + 1,
              url: `${SITE_URL}/blog/${p.slug}`,
          ...
          : [
              { "@type": "ListItem", position: 1, url: `${SITE_URL}/blog/4cs-diamond-grading-cut-colour-clarity-carat`, name: "The 4Cs of Diamond Grading" },
              { "@type": "ListItem", position: 2, url: `${SITE_URL}/blog/lab-grown-diamonds-vs-natural-diamonds-buyers-guide-2026`, name: "Lab Grown vs Natural Diamonds 2026" },
              { "@type": "ListItem", position: 3, url: `${SITE_URL}/blog/how-to-read-diamond-certificate-jewelsreport-guide`, name: "How to Read a Diamond Certificate" },
              { "@type": "ListItem", position: 4, url: `${SITE_URL}/blog/cvd-vs-hpht-lab-grown-diamonds-differences-explained`, name: "CVD vs HPHT Diamonds" },
              { "@type": "ListItem", position: 5, url: `${SITE_URL}/blog/diamond-fluorescence-explained-effect-on-value-certificate`, name: "Diamond Fluorescence Explained" },
              { "@type": "ListItem", position: 6, url: `${SITE_URL}/blog/why-diamond-gemological-certificate-important-before-buying`, name: "Why a Diamond Certificate Is Essential" },
              { "@type": "ListItem", position: 7, url: `${SITE_URL}/blog/ruby-emerald-sapphire-coloured-gemstone-certification-grading`, name: "Ruby, Emerald & Sapphire Certification" },
              { "@type": "ListItem", position: 8, url: `${SITE_URL}/blog/lab-grown-diamond-jewellery-indian-weddings-bridal-guide`, name: "Lab Grown Diamond Bridal Guide India" },
              { "@type": "ListItem", position: 9, url: `${SITE_URL}/blog/diamond-clarity-grades-explained-fl-if-vvs-vs-si-included`, name: "Diamond Clarity Grades Explained" },
              { "@type": "ListItem", position: 10, url: `${SITE_URL}/blog/how-to-verify-diamond-certificate-online-step-by-step`, name: "How to Verify a Diamond Certificate Online" },
            ],
      },
      {
        "@context": "https://schema.org",
