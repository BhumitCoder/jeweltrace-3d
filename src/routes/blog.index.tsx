...
function BlogPage() {
  ...
  useSEO({
    ...
    path: "/blog",
    keywords:
      "diamond grading guide, 4Cs explained, lab grown diamond guide, CVD vs HPHT diamonds, diamond fluorescence, gemstone certification, ruby emerald sapphire grading, how to verify diamond certificate, JewelsReport blog, diamond clarity grades",
    jsonLd: [
      breadcrumb([
        { name: "Home", path: "/" },
